...
class AdditionalFeaturesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdditionalFeaturesScreen> createState() => _AdditionalFeaturesScreenState();
}

class _AdditionalFeaturesScreenState extends ConsumerState<AdditionalFeaturesScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              child: Column(
                ...
                children: [
                  ElevatedButton.icon(
                    onPressed: () {
                      ref.read(additionalFeaturesProvider.notifier).getLoosers();
                    },
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Divider(),
                            ...state.loosers!.map((looser) => ListTile(
                              leading: CircleAvatar(
                                child: Text('${looser.filmsCount}'),
                              ),
                              title: Text(looser.name),
                              subtitle: Text('Паспорт: ${looser.passportID}'),
                              trailing: Text(
            ...
            _buildSection(
              ...
              description: 'Отобрать Оскары у фильмов определенного жанра',
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  DropdownButtonFormField<MovieGenre>(
                    ...
                    items: MovieGenre.values.map((genre) => DropdownMenuItem(
                      value: genre,
                      child: Text(genre.uiString),
                    )).toList(),
                    onChanged: (value) {
                      setState(() => _selectedGenreForHumiliate = value);
                    },
                  ),
            ...
            _buildSection(
              title: '📊 Статистика',
              description: 'Различные статистические данные о фильмах',
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  // Общая длительность
                  Card(
                    child: ListTile(
                      ...
                      title: const Text('Общая длительность всех фильмов'),
                      ...
                      trailing: ElevatedButton(
                        onPressed: () {
                          ref.read(additionalFeaturesProvider.notifier)
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              Expanded(
                                child: DropdownButtonFormField<MovieGenre>(
                                  ...
                                  onChanged: (value) {
                                    setState(() => _selectedGenreForCount = value);
                                  },
                                ),
                              ),
                              const SizedBox(width: 12),
                              ElevatedButton(
                                onPressed: _selectedGenreForCount != null
                                    ? () {
                                  ref.read(additionalFeaturesProvider.notifier)
                                      .calculateMoviesCountByGenre(_selectedGenreForCount!);
                                }
                                    : null,
                          ...
                          ElevatedButton.icon(
                            ...
                            label: const Text('Подсчитать для всех жанров'),
                            style: ElevatedButton.styleFrom(
